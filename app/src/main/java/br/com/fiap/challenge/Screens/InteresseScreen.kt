...
@Composable
fun InteresseScreen(navController: NavHostController, userProfileViewModel: UserProfileViewModel = viewModel()) {
    var interesse by remember { mutableStateOf(TextFieldValue("")) }
    ...
    Column(
        ...
        Text(text = "Áreas de interesse: $interesse")
    }
}
