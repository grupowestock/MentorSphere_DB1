...
@Composable
fun CartaScreen(navController: NavHostController, userProfileViewModel: UserProfileViewModel = viewModel()) {
    var carta by remember { mutableStateOf(TextFieldValue("")) }
    ...
    Column(
        ...
        TextField(
            ...
            label = { Text("Carta da Semana") }
        )
        Spacer(modifier = Modifier.height(16.dp))
        Text(text = "Carta da Semana: $carta")
    }
}
